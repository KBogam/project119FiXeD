...
document.getElementById("imageToBeDrawn").innerHTML="Sketch to be Drawn: "+sketch;
...
{
    timeCounter++;
    document.getElementById("timer").innerHTML="Timer: "+timeCounter;
...
function gotResult(error,results)
{
  ...
  if(error)
  {
    ...
    document.getElementById("sketch").innerHTML="Your Sketch: "+ drawSketch;
